...
import { QueryOperation } from "./bankapiComponents";

export type BankapiContext<
 ...
 */
export function useBankapiContext<
  TQueryFnData = unknown,
  TError = DefaultError,
  TData = TQueryFnData,
  TQueryKey extends QueryKey = QueryKey,
>(
  _queryOptions?: Omit<
    ...
    "queryKey" | "queryFn"
  >,
): BankapiContext<TQueryFnData, TError, TData, TQueryKey> {
  return {
    fetcherOptions: {},
    queryOptions: {},
  };
