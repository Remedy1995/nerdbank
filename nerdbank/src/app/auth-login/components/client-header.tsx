                  ...
                  <div className="header-row">
                    <div className="header-column justify-content-start">
                      ...
                      <div className="logo me-3">
                        <a className="d-flex" href="index.html" title="NerdBank - HTML Template">
                      ...
                      <nav className="primary-menu navbar navbar-expand-sm">
                        <div id="header-nav" className="collapse navbar-collapse">
                          <ul className="navbar-nav me-auto">
                            <li className="active text-gray-900"><a href="/dashboard">Dashboard</a></li>
                            <li className="text-emerald-900"><a href="/transfer-money">Transfer Funds</a></li>
                           ...
                           {/* <li><a href="help.html">Help</a></li>*/}
                            <li className="nav-item dropdown"> <a className="nav-link dropdown-toggle" href="#" id="transferDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">Transfer History</a>
                              <ul className="dropdown-menu mx-4" aria-labelled="transferDropdown">
                                <li><a className="dropdown-item mx-4" href="/all-self-transfers">Self Transfers</a></li>
                                <li><a className="dropdown-item mx-4" href="/all-external-transfers">External Transfers</a></li>
                          ...
                          <li className="nav-item dropdown "> <a className="nav-link dropdown-toggle px-0" href="#" id="profileDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            ...
                            <Image className="rounded-circle" src="/images/profile-thumb-sm.jpg" alt="" width={50} height={50}/></a>
                             <ul className="dropdown-menu profile-drop"  aria-labelledby="profileDropdown">
                              ...
                              <li className="dropdown-divider mx-n3"></li>
                              <li><a className="dropdown-item profile-down" href="/user-profile"><i className="fas fa-user"></i>My Profile</a></li>
