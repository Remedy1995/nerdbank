...
export default function AllSelfTransfers() {
        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-lg-9">
              <h4 className="fw-400 mb-3">Self Transfers</h4>
             {/* <div className="row">
                ...
                <div className="transaction-list">
                  {
                    ...
                    Array.isArray(data) && data.map((val: { _id: string, transferStatus:string,accountbankName: string, descriptionOfTransfer:string,amount: number, accountName: string,created_At:string,transferType:string }) => {
                      ...
                      return (
                        <div className="transaction-item px-4 py-3" data-bs-toggle="modal" data-bs-target="#transaction-detail" key={val?._id} onClick={()=>setSelectedId(val?._id)}>
                          <div className="row align-items-center flex-row overflow-auto">
                            ...
                            <div className="col-2 col-sm-2 d-sm-block text-center text-3 overflow-auto">  <span data-bs-toggle="tooltip" title="Completed">  {val.transferStatus ==='success' ?(<i className="fas fa-check-circle text-success "></i>):(<i className="fas fa-times text-danger"></i>)}</span> {val.transferStatus}</div>
