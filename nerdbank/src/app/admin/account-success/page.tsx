      ...
      <div id="main-wrapper">
        ...
        <div id="content" className="py-4">
          <div className="container">
            ...
            <h2 className="fw-400 text-center mt-3 mb-4">Account Success</h2>
            <div className="row">
              <div className="col-md-9 col-lg-7 col-xl-6 mx-auto">
                <div className="bg-white text-center shadow-sm rounded p-3 pt-sm-4 pb-sm-5 px-sm-5 mb-4">
                  <div className="my-4">
                    <p className="text-success text-20 lh-1">
                      <i className="fas fa-check-circle"></i>
                    </p>
                    <p className="text-success text-8 fw-500 lh-1">Success!</p>
                    <p className="lead">Account Completed</p>
                  </div>
                  <p className="text-3 mb-4">
                    {message} <span className="text-4 fw-500"></span>.See
                    account details under{" "}
                    <a className="btn-link" href="/admin/all-accounts">
                      Accounts
                    </a>
                    .
                  </p>
