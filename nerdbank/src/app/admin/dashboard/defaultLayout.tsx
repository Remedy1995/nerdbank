...
export default function Dashboard() {
  ...
  const totalTransfers =
    Array && Array.isArray(transData)
      ? transData?.reduce((a, b) => a + b?.amount, 0)
      : 0;
              ...
              <div className="col-lg-9">
                ...
                <div className="bg-white shadow-sm rounded py-4 mb-4">
                  ...
                  <div className="transaction-title py-2 px-4">
                    <div className="row">
                      <div className="col-2 col-sm-1 text-start">
                      ...
                      <div className="col-2 col-sm-2 d-sm-block text-start">
                        Status
                      </div>
                          ...
                          return (
                            ...
                            >
                              <div className="row align-items-center flex-row overflow-auto">
                                ...
                                <div className="col-2 col-sm-2 d-sm-block text-start text-3 overflow-auto">
                                  {" "}
                                  <span
