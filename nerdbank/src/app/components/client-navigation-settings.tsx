           ...
           <div className="bg-primary">
                    <div className="container d-flex justify-content-center">
                        <ul className="nav nav-pills alternate nav-lg border-bottom-0">
                            <li className="nav-item"> <a className={firstNav ? "nav-link active": "nav-link"} href="/client/user-profile">Account</a></li>
                            <li className="nav-item"> <a className={secondNav ? "nav-link active": "nav-link"} href="/client/user-settings">Security</a></li>
                            <li className="nav-item"> <a className={thirdNav ? "nav-link active": "nav-link"} href="/client/payment-methods">Payment Methods</a></li>
                        </ul>
                    </div>
                </div>
    )
